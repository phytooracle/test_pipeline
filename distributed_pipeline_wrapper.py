                ...
                "rules": [
                            {
                                ...
                                "outputs" : [out.replace('$PLANT_NAME', os.path.basename(os.path.dirname(file))).replace('${SUBDIR}', os.path.basename(os.path.dirname(file))).replace('${DATE}', date) for out in outputs],
                                "inputs"  : [container, 
                                             seg_model_name, 
